...
import com.epam.gym.util.SHAPasswordEncoder;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/trainees","/trainers", "/users/login" )
                        .permitAll()
                        .anyRequest()
                        .authenticated())
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(Arrays.asList("transactionId"));
