...
import com.epam.gym.handler.RestApiExceptionHandler;
...
class TrainingControllerTest {
    ...
    @BeforeEach
    public void setup() {
       mockMvc = MockMvcBuilders.standaloneSetup(trainingController).setControllerAdvice(new RestApiExceptionHandler()).build();
    }
